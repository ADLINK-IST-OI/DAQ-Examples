...
Module DASK
    ...
    Declare Function CTR_Setup_All Lib "Pci-Dask.dll" (ByVal CardNumber As Short, ByVal CtrCnt As Short, ByRef Ctr As Short, ByRef Mode As Short, ByRef CCount As Integer, ByRef BinBcd As Short) As Short
    ...
    Declare Function CTR_Read_All Lib "Pci-Dask.dll" (ByVal CardNumber As Short, ByVal CtrCnt As Short, ByRef Ctr As Short, ByRef Value As Integer) As Short
