...
namespace _9112_polling
{
    public partial class Form1 : Form
    {
        ...
        private void parameterConfigIntital()
        {
            ...
            AdRange = DASK.AD_B_10_V; /*AI range*/           
            AI_PerChannelCount = 20000;
        ...
        private void DataProcess()
        {
            ...
            while(queue.IsAlive)
            {
                while (myqueue.Count > 0)
                {
                        ...
                        err=DASK.AI_ContVScale(cardRegNumber, DASK.AD_B_10_V, myqueue.Dequeue(), VBuffer[0], (int)AI_TotalReadCount);
                        if (err < 0)
                        {
