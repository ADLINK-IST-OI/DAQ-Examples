...
namespace AIO_Simultaneous_UI
{
    public partial class frm_logger : Form
    {
        ...
        public uint g_data_converter_unit;
        ...
        private void frm_log_Load(object sender, EventArgs e)
        {
            ...
            this.cbox_data_converter_unit.SelectedIndex = (int)g_data_converter_unit;
        ...
        private void btn_data_logger_path_Click(object sender, EventArgs e)
        {
            ...
            dlg.FileName = Path.GetFileName(g_data_logger_path);
            dlg.Title = "Select Path";
            dlg.Filter = "Binary File (*.bin)|*.bin|All File|*";
            dlg.DefaultExt = ".bin";
        ...
        private void btn_data_converter_source_Click(object sender, EventArgs e)
        {
            ...
            dlg.FileName = Path.GetFileName(g_data_converter_source);
        ...
        private void btn_data_converter_destination_Click(object sender, EventArgs e)
        {
            ...
            dlg.FileName = Path.GetFileName(g_data_converter_destination);
            dlg.Title = "Select Destination";
            dlg.Filter = "Comma Separated File (*.csv)|*.csv|All File|*";
            dlg.DefaultExt = ".csv";
            dlg.CheckFileExists = false;
            if (dlg.ShowDialog() == System.Windows.Forms.DialogResult.OK && dlg.FileName != null)
            {
        ...
        private void cbox_data_converter_unit_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (sender != null)
            {
                ComboBox tmp_cbox_data_converter_unit = (ComboBox)sender;
                g_data_converter_unit = (uint)tmp_cbox_data_converter_unit.SelectedIndex;
        ...
        private void btn_data_converter_start_Click(object sender, EventArgs e)
        {
            if (sender != null)
            {
                ...
                try
                {
                    ...
                    double[] ai_chnl_sensitivity = new double[4] {data_converter_file_info.ai_chnl_sensitivity0, data_converter_file_info.ai_chnl_sensitivity1, data_converter_file_info.ai_chnl_sensitivity2, data_converter_file_info.ai_chnl_sensitivity3};
        ...
        private void btn_data_converter_folder_Click(object sender, EventArgs e)
        {
            if (sender != null)
            {
                if (g_data_converter_destination != "" &&  Directory.Exists(Path.GetDirectoryName(g_data_converter_destination)))
                {
