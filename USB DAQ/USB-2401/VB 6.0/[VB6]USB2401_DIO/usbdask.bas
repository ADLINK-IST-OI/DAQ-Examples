...
Global Const P2405_AI_CH_0 = &H0
Global Const P2405_AI_CH_1 = &H1
Global Const P2405_AI_CH_2 = &H2
Global Const P2405_AI_CH_3 = &H3


' Input Coupling
Global Const P2405_AI_EnableIEPE = &H4
Global Const P2405_AI_DisableIEPE = &H8
Global Const P2405_AI_Coupling_AC = &H10
Global Const P2405_AI_Coupling_None = &H20
                   

' Input Type
Global Const P2405_AI_Differential = &H0
Global Const P2405_AI_PseudoDifferential = &H40
       
' Conversion Source
Global Const P2405_AI_CONVSRC_INT = &H0
Global Const P2405_AI_CONVSRC_EXT = &H200

' Trigger Source
Global Const P2405_AI_TRGSRC_AI0 = &H200
Global Const P2405_AI_TRGSRC_AI1 = &H208
Global Const P2405_AI_TRGSRC_AI2 = &H210
Global Const P2405_AI_TRGSRC_AI3 = &H218
Global Const P2405_AI_TRGSRC_SOFT = &H380
Global Const P2405_AI_TRGSRC_DTRIG = &H388

' Trigger Edge
Global Const P2405_AI_TrgPositive = &H4
Global Const P2405_AI_TrgNegative = &H0

' Gated Trigger Level
Global Const P2405_AI_Gate_ActiveHigh = &H4
Global Const P2405_AI_Gate_ActiveLow = &H0

' ReTrigger
Global Const P2405_AI_EnReTigger = &H2000

' AI Trigger Mode
Global Const P2405_AI_TRGMOD_POST = &H0
Global Const P2405_AI_TRGMOD_DELAY = &H4000
Global Const P2405_AI_TRGMOD_PRE = &H8000
Global Const P2405_AI_TRGMOD_MIDDLE = &HC000
Global Const P2405_AI_TRGMOD_GATED = &H1000

' UD_DIO_2405_Config
Global Const P2405_DIGITAL_INPUT = &H30
Global Const P2405_COUNTER_INPUT = &H31
Global Const P2405_DIGITAL_OUTPUT = &H32
Global Const P2405_PULSE_OUTPUT = &H33
...
Declare Function UD_AI_ReadMultiChannels Lib "Usb-Dask.dll" (ByVal CardNumber As Integer, ByVal NumChans As Integer, Chans As Integer, AdRanges As Integer, ByRef Buffer As Long) As Integer
