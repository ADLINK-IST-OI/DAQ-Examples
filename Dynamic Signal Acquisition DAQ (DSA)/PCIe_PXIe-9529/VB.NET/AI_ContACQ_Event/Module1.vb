...
Module Module1
    ...
    Sub exit_handle()
        ...
        If config_para.is_done_evt_set Then
            ' Reset done event
            DSA_DASK.DSA_AI_EventCallBack(config_para.card_handle, 0, DSA_DASK.DBEvent, ai_buf_ready_cbdel)
        End If
    ...
    Sub Main()
        ...
        result = DSA_DASK.DSA_AI_EventCallBack(config_para.card_handle, 1, DSA_DASK.DBEvent, ai_buf_ready_cbdel)
        If result <> DSA_DASK.NoError Then
