...
Declare Function DO_7360_ExportSampCLKConfig Lib "Pci-Dask.dll" (ByVal CardNumber As Integer, ByVal CLK_Src As Integer, ByVal CLK_DPAMode As Integer, ByVal CLK_DPAVlaue As Integer) As Integer
