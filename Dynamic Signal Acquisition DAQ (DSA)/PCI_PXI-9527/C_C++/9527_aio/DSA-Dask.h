...
#define DAQ_AI					0
#define DAQ_AO					1
#define PXI9527_AIO_1to1		2
#define PXI9527_AIO_2to1		3
/*EEPROM*/
 ...
 */
/*Timebase Source*/
#define P9527_Internal				0x0
#define P9527_PXI10M				0x1
...
I16 __stdcall DSA_GetGeoAddr(U16 wCardNumber, U16 *wSlotID);
I16 __stdcall DSA_GetLCRAddr(U16 CardNumber, U32 *LcrAddr);
I16 __stdcall DSA_GetSerialNumber(U16 wCardNumber, U8 *SerialString, U8 numberOfElements, U8* actualread);
