...
namespace AI_ACQ_ReTrigInf
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            config_para.trig_ready_cnt = 0;
            do {
                // In retrigger mode, you can use this function to check the operation status.
                // If number of triggers is infinite, the 4th parameter of this function returns index of ready buffer.
                result = DSA_DASK.DSA_AI_AsyncReTrigNextReady(config_para.card_handle, out config_para.is_trig_ready,
                                                              out config_para.op_stopped, out config_para.trig_ready_idx);
                if (result != DSA_DASK.NoError)
                {
