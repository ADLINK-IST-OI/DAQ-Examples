    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            do {
                ...
                result = DSA_DASK.DSA_AI_AsyncDblBufferHalfReady(config_para.card_handle, out config_para.is_buf_ready, out config_para.op_stopped);
                if (result != DSA_DASK.NoError)
                {
                    Console.Write("\nFalied to perform DSA_AI_AsyncDblBufferHalfReady(), error: " + result);
                    exit_handle();
                }
